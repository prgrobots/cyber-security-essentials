...
As no two businesses or organizations face identical cyber security environments, even if offering similar services or goods, each business or organization needs to develop its own unique Information Security Management System (ISMS). 
...
Information Security Manual (ISM) - Australian Cyber Security Centre (ACSC) and the Essential 8 mitigation strategies
NIST (USA gov) Cybersecurity Framework (NIST CSF)
...
USA New Laws: The ISACA group track law enacted related to cyber security. Examples of these USA laws include: Cybersecurity Act, Federal Exchange Data Breach Notification Act and the Data Accountability and Trust Act. http://www.isaca.org/cyber/pages/cybersecurityl egislation.aspx
The Australian Cyber Security Act 2024 and the Security of Critical Infrastructure Act 2018 and updated Data Breach laws and regulations has forced a huge upgrade in cyber security spending and importance to Australian businesses and organizations.
