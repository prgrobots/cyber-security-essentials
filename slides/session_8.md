...
# Diagrams
 ```mermaid
---
title: Cloud-Based Cybersecurity Framework Components
---
flowchart TD
    A[Cybersecurity Policy] --> B[Risk Assessment]
    B --> C[Security Controls]
    C --> D[Incident Response]
```
```mermaid
---
title: Cloud-Based Security Technologies
---
flowchart LR
    A[Cloud Security Gateways (CSGs)] --> B[Cloud Access Security Brokers (CASBs)]
    B --> C[Cloud Security Posture Management (CSPM)]
    C --> D[Cloud Identity and Access Management (CIAM)]
```
