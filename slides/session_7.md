...
---
flowchart TD
    Z1[DMZ] -->|Access Restricted| Z2[Intranet]
    Z2 -->|Access Restricted| Z3[Internet]
```
```mermaid
---
title: Network Security Threats and Mitigation
---
flowchart TD
    T1[Malware] --> M1[Antivirus Software]
    T2[Phishing] --> M2[Educate Users]
    U1[Update OS/Software] -->|Prevent Exploitation| M3[Failing to Implement Security Measures]
```
